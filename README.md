...
- Running the workshop Julia [examples](https://github.com/GeoscienceAustralia/HiQGA.jl/tree/workshop/examples/workshop) given in this branch in the `examples` directory. See [here](https://www.youtube.com/watch?v=edgzr8vpCKY&list=PL0jP_ahe-BFmRWx6IT9G2zbFHA6qmJ52f&index=6) to follow along
