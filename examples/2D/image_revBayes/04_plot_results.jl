...
rownum, colnum = 210, 100
transD_GP.plot_image_posterior(opt, optλ, img, burninfrac=0.5, rownum=rownum, colnum=colnum, nbins=100)
...
transD_GP.getchi2forall(optλ, fsize=8, alpha=0.5)
ax = gcf().axes
ax[2].plot(xlim(), [χ²/2 , χ²/2], "--", color="gray")
