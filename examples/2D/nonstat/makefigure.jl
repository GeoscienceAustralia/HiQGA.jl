...
im1 = ax[1].imshow(img.f, extent=[img.x[1],img.x[end],img.y[end],img.y[1]], vmin=vmin, vmax=vmax)
ax[1].text(100, 170, "a. True image", color="w", fontsize=10, alpha=0.8)
ax[3].imshow(img.f, extent=[img.x[1],img.x[end],img.y[end],img.y[1]], alpha=0.0, vmin=vmin, vmax=vmax)
...
ax[2].imshow(m, extent=[img.x[1],img.x[end],img.y[end],img.y[1]], vmin=vmin, vmax=vmax)
ax[2].text(100, 170, "c. Fixed λ", color="w", fontsize=10, alpha=0.8)
ax[4].imshow(mns, extent=[img.x[1],img.x[end],img.y[end],img.y[1]], vmin=vmin, vmax=vmax)
