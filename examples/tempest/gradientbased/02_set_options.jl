...
regtype = :R2 # :R1 is first difference regularization, :R2 is two succesive first differences
...
β² = 0.01 # what fraction of roughness penalty to use to enforce a penalty in deviations from background