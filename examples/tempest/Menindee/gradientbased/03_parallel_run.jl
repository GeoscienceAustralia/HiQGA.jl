...
@info "starting"
transD_GP.loopacrossAEMsoundings(soundings, aem, σstart, σ0, Δ;
                            nsequentialiters, regtype, nstepsmax, ntries,           
                            lo, hi, λ²min, λ²max, β², knownvalue,              
                            zipsaveprefix, ntriesnu, boxiters, usebox, reducenuto, debuglevel, breaknuonknown)                
