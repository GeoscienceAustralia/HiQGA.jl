...
σ0 .= -3 # constant value assigned to multiple elements of array (background)
...
ntries = 10 # how many max tries between λ²min, λ²max
β² = 1. # what fraction of roughness penalty to use to enforce a penalty in deviations from background