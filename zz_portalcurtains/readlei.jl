...
## plot
xrd, yrd, axd = transD_GP.plotmanygrids(σ, X, Y, Z, zall; dr, vmin, vmax, donn, xl, yl, δ²=linesmoothδ², figsize=(20,8),
    preferEright=true, plotbinning=true, fontsize=10, delbin, spacefactor=2)