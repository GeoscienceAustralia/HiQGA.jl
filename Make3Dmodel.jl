...
Tools3D.slicemodel(ρ,0,[0. 0.],[0.], opt, slicesx=[20], slicesy=[20], slicesz=[17], dz=dz, extendfrac=extendfrac)
...
Tools3D.plot_last_target_model(opt, d, sd; slicesx=[20], slicesy=[20], slicesz=[17], dz=dz, extendfrac=extendfrac)
rmprocs(workers())
